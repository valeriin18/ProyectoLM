    ...
    return (
        <div className="container mt-5 top">
            ...
            <Row xs={1} md={4} className="g-4 mt-1 mb-5">
                {activitiesInTime.map((activitiesInTime) => (
                    <Col key={activitiesInTime.idActivity}>
                        <Card>
                            <Card.Body>
                                <Card.Title><span style={{ fontWeight: 'bold' }}>Nombre:</span> {activitiesInTime.model.name}</Card.Title>
                                <Card.Text><span style={{ fontWeight: 'bold' }}>Fecha:</span> {activitiesInTime.datetime}</Card.Text>
                                <Card.Text><span style={{ fontWeight: 'bold' }}>Descripcion:</span> {activitiesInTime.model.description}</Card.Text>
